...
export ccaTrSta=-62 #CSR_Threshold(STA)
export ccaTrAp=-62 #CSR_Threshold(AP)
...
#Run
export test="RngRun${RngRun}_Duration${duration}_${nBss}BSS_${n}STA_r${r}_d${d}_cca${ccaTrSta}"
run_one
