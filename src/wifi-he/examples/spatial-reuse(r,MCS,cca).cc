...
///////////////////////////////////////////////////////////////Pass Loss Modelの設定（ここから）///////////////////////////////////////////////////////////////////////////
  ...
  if (enableThresholdPreambleDetection)
    {
      spectrumPhy.SetPreambleDetectionModel ("ns3::ThresholdPreambleDetectionModel"); //preamble detectionありのモデルの設定(この関数がCS/CCAを決定する：threshold-preamble-detection-model.cc)
    }
...
////////////////////////////////////////////////////////////////////CCA-ED、PHYのパワーを設定（ここから）/////////////////////////////////////////////////////////////////////////////////////////
  ...
  std::cout << "CCA-ED_Threshold(BSS1_STA) = " << ccaTrSta1 << std::endl;
  // Network "A"
  Ssid ssidA = Ssid ("A");
  ...
  if (nBss >= 2)
    {
      ...
      spectrumPhy.Set ("RxSensitivity", DoubleValue (rxSensitivity));
      std::cout << "CCA-ED_Threshold(BSS2_STA) = " << ccaTrSta2 << std::endl;
      // Network "B"
      Ssid ssidB = Ssid ("B");
      if (enableObssPd)
        {
